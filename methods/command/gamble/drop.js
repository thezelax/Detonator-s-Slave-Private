...
module.exports = new CommandInterface({
	...
	desc:"Drop some cowoncy in a channel with 'ds drop {amount}'! Users can pick it up with 'ds pickup {amount}' If you try to pick up more than what's on the floor, you'll lose that amount! Be careful!",

	example:["ds drop 3000"],
